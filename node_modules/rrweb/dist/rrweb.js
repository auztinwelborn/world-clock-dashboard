var rrweb = (function (exports) {
    ...
    function initInputObserver({
      ...
      function cbWithDedup(target, v) {
        ...
        if (!lastInputValue || lastInputValue.text !== v.text || lastInputValue.isChecked !== v.isChecked) {
          ...
          const id = mirror.getId(target);
          callbackWrapper(inputCb)(__spreadProps$3(__spreadValues$4({}, v), {
            id
          }));
        }
      }
    ...
    class ShadowDomManager {
      ...
      addShadowRoot(shadowRoot, doc) {
        ...
        const observer = initMutationObserver(__spreadProps$2(__spreadValues$3({}, this.bypassOptions), {
          doc,
        ...
        this.restoreHandlers.push(initScrollObserver(__spreadProps$2(__spreadValues$3({}, this.bypassOptions), {
