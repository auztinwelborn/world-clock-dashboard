var rrwebRecord = (function () {
    ...
    function initInputObserver({
      ...
      function cbWithDedup(target, v) {
        ...
        if (!lastInputValue || lastInputValue.text !== v.text || lastInputValue.isChecked !== v.isChecked) {
          ...
          const id = mirror.getId(target);
          callbackWrapper(inputCb)(__spreadProps$1(__spreadValues$2({}, v), {
            id
          }));
        }
      }
    ...
    class ShadowDomManager {
      ...
      addShadowRoot(shadowRoot, doc) {
        ...
        const observer = initMutationObserver(__spreadProps(__spreadValues$1({}, this.bypassOptions), {
          doc,
        ...
        this.restoreHandlers.push(initScrollObserver(__spreadProps(__spreadValues$1({}, this.bypassOptions), {
